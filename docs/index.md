...
This GitPage serves as an open-source publication of the methods used to wrangle and analyze the data I used for my masters project. Below are Rmarkdowns with the code that I used in addition to the data visualizations that I created in RStudio. All maps were created by me in ArcGIS Pro. All photos were taken by me. You can read my full submitted thesis [here](<a href="elizabethmax.github.io/SEFI-Intertidal-1993-2011/Elizabeth-Max_SEFI-Rocky-Intertidal-1993-2011_Masters-Thesis-SFSU_12-2024.pdf" target="_blank">PDF.</a>)<br> 
